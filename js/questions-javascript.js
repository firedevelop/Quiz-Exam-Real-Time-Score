export const questions = [
    {
      question: "1. Which keyword is used to declare a variable that cannot be reassigned in JavaScript?",
      options: ["var", "let", "const", "static"],
      answer: 2,
      explanation: "The `const` keyword is used to declare a variable that cannot be reassigned after its initial assignment.",
    },
    {
      question: "2. Which of the following is NOT a valid data type in JavaScript?",
    ...
    {
          question: "4. What is the purpose of the `typeof` operator in JavaScript?",
       ...
       {
         question: "5. Which of the following is used to add an element to the end of an array?",
     ...
     },
     {
      ...
      {
        question: "7. What does the `JSON.stringify()` method do in JavaScript?",
      ...
      {
          question: "9.  Which method is used to remove the first element from an array?",
      ...
      {
        question: "10. What does the spread operator (...) do in JavaScript?",
